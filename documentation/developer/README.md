...
If you want to modify this project, here are some pointers and areas of possible improvement (there are many, as this is
just a prototype).
...
2. If you were to add a new sensor or output to the device...
  ...
  * If your sensors have output that needs to be written to the device and back to the UI, make sure you implement each sensor in the following order:
    ...
    2. Create variables that refer to those UI elements in the DOM within JS files and attach event listeners as needed
